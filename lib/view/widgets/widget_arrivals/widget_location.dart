...
class SubwayLocationInfo extends StatelessWidget {
  ...
  String subwayIcon = FindMySubwayApp.themeNotifier.value == ThemeMode.light ? "subway" : "subway_white";

  SubwayLocationInfo(List<StationInform> stData, int curSt, Map<String, Map<int, StArrivalInfo>> stStatus) {
    this.stData = stData;
    this.curSt = curSt;
